<template>
	<div style="padding: 20px;">
		...
		<el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
			...
			<el-table-column fixed="right" label="操作">
				<template slot-scope="scope">
					...
					<el-button type="text" size="small" @click="handleClick(scope.row)"><i
							class="el-icon-edit"></i> 编辑</el-button>
					<el-button type="text" size="small" style="color:red;"><i class="el-icon-delete"></i> 删除
					</el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		<el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
			:current-page="page.pageNumber + 1" :page-sizes="[10, 20, 30, 100]" :page-size="page.pageSize"
