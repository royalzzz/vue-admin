<template>
	<div style="padding: 15px">
		...
		<h2>问题类型与意图标注</h2>
		<el-alert title="提示: 输入问题时请注意问题的提示，避免重复的问题文本！批量标注问题请先检查是否已有该批量的相关问题。" type="info" show-icon
		...
		<el-tabs v-model="activeName" @tab-click="changeTab">
			<el-tab-pane label="自定义问题" name="first">
				...
				<el-form label-width="80px" size="large" style="margin-top:20px;">
					...
					<el-form-item>
						<el-button type="primary" style="width: 480px;" @click="onSubmit" v-loading="loading">
							提交</el-button>
					</el-form-item>
				</el-form>
			</el-tab-pane>
			<el-tab-pane label="批量生成" name="second">
				...
				<el-form label-width="80px" size="large" style="margin-top:20px;">
					<el-form-item label="批量规则">
						<el-input ref="batchTextRef" v-model="batchText" placeholder="请输入内容"
							style="width: 600px;"></el-input>
						<el-button type="info" plain style="margin-left:10px;"
							@click="insertIntoText('#CHEMICAL')">插入 #CHEMICAL</el-button>
					...
					<el-form-item label="问题类型">
						<el-select multiple v-model="questionType" placeholder="请选择问题类型" style="width: 600px;">
							<el-option v-for="item in questionTypes" :key="item.id" :label="item.name"
								:value="item.id">
							</el-option>
						</el-select>
					...
					<el-form-item>
						<el-button type="primary" style="width: 600px;" @click="onSubmitBatch"
							icon="el-icon-document-copy" v-loading="loading" disabled>
							批量生成</el-button>
					</el-form-item>
				</el-form>
			</el-tab-pane>
			<el-tab-pane label="模板生成" name="third">
				<el-alert title="模板生成问题提示" type="info"
				...
				<el-form label-width="80px" size="large" style="margin-top:20px;">
					...
					<el-form-item>
						<el-button type="primary" style="width: 600px;" @click="onSubmitBatch"
							icon="el-icon-printer" v-loading="loading" disabled>
							模板生成</el-button>
					</el-form-item>
				</el-form>
			</el-tab-pane>
			<el-tab-pane label="问题标注管理" name="fourth">
				...
				<el-table :data="questions" stripe style="width: 100%" v-loading="tableLoading">
					...
					<el-table-column fixed="right" label="操作">
						<template slot-scope="scope">
							...
							<el-button type="text" size="small" @click="handleClick(scope.row)" disabled><i
									class="el-icon-edit"></i> 编辑</el-button>
							<el-button type="text" size="small" style="color:red;"><i class="el-icon-delete"></i>
								删除
							</el-button>
						</template>
					</el-table-column>
				...
				<el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
					...
					:page-size="page.pageSize" background layout="total, sizes, prev, pager, next, jumper"
					:total="page.total" @next-click="nextPage" @prev-click="prevPage">
				</el-pagination>
			</el-tab-pane>
		</el-tabs>
