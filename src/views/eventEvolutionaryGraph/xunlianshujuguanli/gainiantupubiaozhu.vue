...
<div style="padding: 20px">
  <el-form :model="biaozhunNodepair" ref="numberValidateForm" label-width="100px" class="demo-ruleForm">
    ...
    <el-form-item
      ...
      <el-input type="textarea" :rows="2" v-model.number="biaozhunNodepair.biaozhutext" autocomplete="off"></el-input>
    </el-form-item>
    <el-form-item>
  ...
  <el-table :data="records" border max-height="440px" style="width: 100%" v-loading="loading">
